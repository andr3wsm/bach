...
Il linguaggio SQL, il più diffuso tra i linguaggi di interrogazione per basi di dati relazionali, è supportato da tutti i principali linguaggi di programmazione e ambienti di sviluppo, prestandosi così a integrarsi facilmente in applicazioni complesse e che permettono, ad esempio, l'interazione attraverso un'interfaccia grafica dedicata.
