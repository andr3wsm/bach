...
\title{Progettazione e implementazione \\ di una base di dati centralizzata \\ per il percorso gravidanza e parto}
%% "a beneficio della Clinica Ostetrica dell’Ospedale di Udine"
\author{Andrea Salvador}
\supervisor{Prof.\ Angelo Montanari}
\cosupervisor{Dott.\ Andrea Brunello (forse)}
