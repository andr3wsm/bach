...
\begin{itemize}
\item[\Con{}] Per ogni gravidanza, in \tab{visita} esiste un solo record che ha valore \val{primo\_trimestre} nel campo \at{categoria\_visita}.
\item[\Con{}] Per ogni gravidanza, in \tab{visita} esiste un solo record che ha valore \val{secondo\_trimestre} nel campo \at{categoria\_visita}.
...
\item[\Con{}] L'attributo \at{kristeller} di \tab{parto\_con\_travaglio} è assente se e solo se \at{sottotipo\_parto} ha valore \val{cesareo\_urgente}.
\end{itemize}
